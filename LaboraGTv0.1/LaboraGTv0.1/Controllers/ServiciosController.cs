...
namespace LaboraGTv0._1.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idServicio,descripcion")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idServicio,descripcion")] Servicio servicio)
        {
            if (ModelState.IsValid)
            {
